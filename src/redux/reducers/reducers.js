import { ADD_TO_FAVORITES, REMOVE_FROM_FAVORITES, ADD_MOVIE, EDIT_MOVIE, REMOVE_FROM_MOVIES } from '../action/action';
...
const initialState = {
  ...
  movies: JSON.parse(localStorage.getItem('movies')) || [
    {
      ...
      "description": "Andy Dufresne, wrongly convicted of murder, ends up in Shawshank prison. There he finds friendship, meaning in life, and a way to gain freedom.",
      "rating": 9.3,
  ...
  },
  {
      "id": 2,
      "title": "The Godfather",
      "description": "The story of the Corleone family, one of the most powerful Mafia organizations in the US.",
      "rating": 9.2,
  ...
  },
  {
      ...
      "description": "Bruce Wayne faces a new challenge - The Joker, who seeks to plunge Gotham into chaos.",
      "rating": 9.0,
      ...
      "image": "https://upload.wikimedia.org/wikipedia/sco/8/83/Dark_knight_rises_poster.jpg"
  },
  {
      "id": 4,
      "title": "12 Angry Men",
      "description": "12 jurors must reach a unanimous verdict on the fate of a young man accused of murder.",
      "rating": 8.9,
      ...
      "image": "https://upload.wikimedia.org/wikipedia/commons/f/f3/Twelve_Angry_Men.png"
  },
  {
      "id": 5,
  ...
  },
  {
      "id": 10,
      "title": "Inception",
      "description": "A thief who enters the dreams of others to steal secrets from their subconscious must plant an idea into his target's mind.",
      "rating": 8.8,
...
export const favoritesReducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case REMOVE_FROM_FAVORITES:
      newState = { ...state, favorites: state.favorites.filter(movie => movie.id !== action.payload) };
      break;
    case ADD_MOVIE:
      newState = { ...state, movies: [...state.movies, action.payload] };
      break;
    case EDIT_MOVIE:
      newState = {
        ...state,
  ...
  localStorage.setItem('movies', JSON.stringify(newState.movies));
  return newState;
};